...
export function createTableSongSelector() {
    tableSongSelector = document.createElement("div");
    tableSongSelector.className = CONTAINER_CLASS;
    ...
    songs.forEach(song => {
        ...
        fileSizeElement.innerText = "Calculating...";
        ...
        tableSongSelector.appendChild(songRow);
    });

    return tableSongSelector;
}
